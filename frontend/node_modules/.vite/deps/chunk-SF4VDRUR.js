...
function hydrateKeyframes(valueName, keyframes2, read2) {
  for (let i = 0; i < keyframes2.length; i++) {
    if (keyframes2[i] === null) {
      keyframes2[i] = i === 0 ? read2() : keyframes2[i - 1];
    }
...
//# sourceMappingURL=chunk-SF4VDRUR.js.map
